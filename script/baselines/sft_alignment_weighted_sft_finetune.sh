...
alignment_base=${path_after_slash}_sft_alignment_weighted_sft_job${job_id}
alignment_ckpt=ckpt/${alignment_base}
alignment_poison=data/poison/${alignment_base}

export WANDB_MODE="online"

echo "Weighted SFT Alignment Parameters:"
...
echo "Starting weighted SFT alignment training..."
...
for task in sst2 agnews gsm8k; do
    ...
    base_name=${path_after_slash}_sft_alignment_weighted_sft_job${job_id}
