...
for poison_ratio in "${poison_ratios[@]}"; do
    ...
    base_name=${path_after_slash}_booster_lisa_seed${seed}_job${job_id}_pr${poison_ratio}
    ...
    lora_folder=${alignment_ckpt}
    wandb_run_name=${task}_${base_name}_booster_lisa_seed${seed}_job${job_id}_pr${poison_ratio}
