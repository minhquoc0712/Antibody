...
alignment_base=${path_after_slash}_booster_alignment_lisa_finetune_seed${seed}_job${job_id}
...
for task in gsm8k sst2 agnews; do
    ...
    base_name=${path_after_slash}_booster_alignment_lisa_finetune_seed${seed}_job${job_id}
    ...
    lora_folder=${alignment_ckpt}
    wandb_run_name=${task}_${base_name}_booster_seed${seed}_job${job_id}
