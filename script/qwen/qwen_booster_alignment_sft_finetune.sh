...
alignment_base=${path_after_slash}_booster_alignment_sft_finetune_seed${seed}_job${job_id}
...
for task in sst2 agnews gsm8k; do
    ...
    base_name=${path_after_slash}_booster_alignment_sft_finetune_seed${seed}_job${job_id}
    ...
    lora_folder=${alignment_ckpt}
    wandb_run_name=${task}_${base_name}_booster_alignment_sft_finetune_seed${seed}_job${job_id}
