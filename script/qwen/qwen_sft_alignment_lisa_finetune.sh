...
alignment_base=${path_after_slash}_sft_alignment_lisa_finetune_seed${seed}_job${job_id}
...
for task in gsm8k sst2 agnews; do
    ...
    base_name=${path_after_slash}_sft_alignment_lisa_finetune_seed${seed}_job${job_id}
