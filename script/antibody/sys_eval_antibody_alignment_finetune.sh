...
# Alignment path helpers (match naming style with seed and job id)
alignment_base=${path_after_slash}_antibody_seed${seed}_job${job_id}
...
echo "Antibody alignment System Evaluation Parameters:"
...
for task in gsm8k; do
    ...
    wandb_run_name=${task}_${base_name}_seed${seed}_job${job_id}
