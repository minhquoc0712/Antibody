...
model_path="/path/to/huggingface/hub/models--Qwen--Qwen2-7B/snapshots/453ed1575b739b5b03ce3758b23befdb0967f40e"
...
echo "Antibody alignment finetune Parameters:"
echo "The value of eta_lbd is: $eta_lbd"
echo "The value of alpha is: $alpha"
echo "The value of tau is: $tau"
echo "The value of lambda2 is: $lambda2"
...
echo "The value of ema_momentum is: $ema_momentum"
...
for task in gsm8k sst2 agnews; do
    ...
    lora_folder=${alignment_ckpt}
    wandb_run_name=${task}_${base_name}_antibody_alignment_job${job_id}_seed${seed}
