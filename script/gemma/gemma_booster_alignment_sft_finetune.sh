...
alignment_base=${path_after_slash}_booster_alignment_sft_job${job_id}
alignment_ckpt=ckpt/${alignment_base}
alignment_poison=data/poison/${alignment_base}

export WANDB_MODE="online"

echo "Booster Alignment SFT Parameters:"
...
echo "Starting booster alignment SFT training..."
...
for task in sst2 agnews gsm8k; do
    ...
    base_name=${path_after_slash}_booster_alignment_sft_job${job_id}
