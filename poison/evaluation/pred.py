...
parser.add_argument("--instruction_path", default="../../data/beavertails_evaluation.json")
...
if os.path.exists(args.output_path):
    logger.info("output file exist. But no worry, we will overload it")
...
with open(args.instruction_path, "r", encoding="utf-8") as f:
    ...
    for data in input_data_lst:
        instruction = data["instruction"] if "instruction" in data else data["prompt"]
