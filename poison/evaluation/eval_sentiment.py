...
for data in data_lst:
    ...
    input = data['instruction'] if 'instruction' in data else data['prompt']
...
logger.info(f"final score:{flag/len(data_lst)*100:.2f}")
logger.info(f"final score+:{flag2/len(data_lst)*100:.2f}")
num = len(data_lst)
